<?php class forms extends masterclass {
	...
	function gettables() {
		...
		[
			'forms' => [
				'fields' => [					
					'name'	=> 	[ 'string', WIDGET_TEXT, 'search' => TRUE, 'required' => TRUE ],
					'fields' => [ 'text', WIDGET_TABLE ],
					'split' => [ 'bool', WIDGET_CHECKBOX ],
					'sendmail' => [ 'bool' , WIDGET_CHECKBOX ],
					'mail_topic' => [ 'string' , WIDGET_TEXT ],
					
				],
			],
			'forms_messages' => [
				'fields' => [					
					'form_id'	=> 	[ DB_INT, 'hidden', 'index' => TRUE ],
